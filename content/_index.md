...
I'm currently studying Computer Science and Engineering (Data Science) at GGSIPU.
...
## [KDE Control Centre](https://github.com/Prayag2/kde_controlcentre)
*JavaScript, QML, Linux*  
...
## [MatchX](https://github.com/Prayag2/matchx)
*C++, Python, Redis, FastAPI, WebSockets, Docker*  
MatchX is a low-latency cryptocurrency matching engine written in C++. It can handle more than 20,000 orders per second. It also includes a REST API for creating orders and a WebSocket API for sending real-time market data.
...
## Google Summer of Code · KDE Community
*Open Source Contributor • May 2026 – Sep 2026*  
...
## Bharti Airtel
*Python Development Intern • Jun 2024 – Aug 2024*  
